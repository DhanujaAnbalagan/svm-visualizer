  ...
  const kernelOptions = [
    {
      ...
      title: 'Linear Kernel',
      icon: Target,
      description: "Best for linearly separable data. Creates straight decision boundaries.",
      color: "text-blue-400",
    ...
    },
    {
      ...
      icon: GitBranch,
      description: "Handles curved boundaries. Good for moderately complex patterns.",
    ...
    },
    {
      ...
      title: 'RBF Kernel',
      icon: Zap,
      description: "Radial Basis Function. Excellent for complex, non-linear patterns.",
    ...
    <div className="min-h-screen bg-gradient-canvas py-8">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-4">SVM Visualizer</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Interactive Support Vector Machine visualization tool. Add data points and watch the algorithm work in real-time.
          </p>
        </div>
        ...
        <Card className="p-8 mb-8 bg-gradient-canvas animate-scale-in border border-border/50 backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-foreground">Kernel Selection</h2>
          </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-lg ${kernel.bgColor} ${kernel.borderColor} border`}>
                          <IconComponent className={`w-5 h-5 ${kernel.color}`} />
                        </div>
                        <h3 className="text-lg font-semibold text-foreground">{kernel.title}</h3>
                      </div>
                      {isSelected && (
        ...
        <Card className="p-6 mt-8 bg-card/50 border-border/50">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-foreground">Understanding the Visualization:</h4>
              <ul className="text-sm text-muted-foreground space-y-1">
